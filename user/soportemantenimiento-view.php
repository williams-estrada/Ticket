<div class="container">
  <div class="row well">
    <div class="col-sm-3">
      <img src="img/Tran.png" class="img-responsive" alt="Image">
    </div>
    <div class="col-sm-9 lead">
      <h2 class="text-info">Bienvenido al centro de soporte de Tranlisur</h2>
  ...
  <div class="row">
    <div class="col-sm-6">
      <div class="panel panel-info">
        <div class="panel-heading text-center"><i class="fa fa-file-text"></i>&nbsp;<strong>Nuevo Ticket De Mantenimiento</strong></div>
        <div class="panel-body text-center">
          ...
          <a type="button" class="btn btn-info" href="./index.php?view=ticketmantenimiento">Nuevo Ticket</a>
        </div>
      </div>
    </div><!--fin col-md-6-->
    ...
    <div class="col-sm-6">
      <div class="panel panel-danger">
        <div class="panel-heading text-center"><i class="fa fa-link"></i>&nbsp;<strong>Comprobar Estado De Ticket De Mantenimiento</strong></div>
        <div class="panel-body text-center">
