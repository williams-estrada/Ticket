...
<nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
    <div class="container-fluid">
        <div class="navbar-header">
            ...
            <a class="navbar-brand" href="index.php"><i class="fa fa"></i>&nbsp;&nbsp;Desarrollado Por El Ing. Williams</a>
        </div>
        <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
            ...
            <ul class="nav navbar-nav navbar-right">
                <li class="dropdown">
                    ...
                    <ul class="dropdown-menu">
                        ...
                        <li>
                            <a href="admin.php?view=ticketadminmantenimiento"><span class="glyphicon glyphicon-envelope"></span> &nbsp; Administrar Tickets De Mantenimiento</a>
                        </li>
                        <li>
            ...
            <ul class=" nav navbar-nav navbar-right">
                ...
                <li>
                    <a href="./index.php?view=soportemantenimiento"><span class="glyphicon glyphicon-flag"></span>&nbsp;&nbsp;Mantenimiento Unidades</a>
                </li>
    ...
    <div class="modal-dialog modal-sm">
      <div class="modal-content">
            <div class="modal-header">
              ...
              <h4 class="modal-title text-center text-primary" id="myModalLabel">Bienvenido a Tranlisur</h4>
            </div>
