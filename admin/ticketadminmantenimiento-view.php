...
<?php if( $_SESSION['nombre']!="" && $_SESSION['clave']!="" && $_SESSION['tipo']=="admin"){ ?>
        <div class="container">
          <div class="row">
            ...
            <div class="col-sm-10">
              <p class="lead text-info">Bienvenido administrador, aqui se muestran todos los Tickets de Tranlisur los cuales podra eliminar, modificar e imprimir.</p>
            </div>
          </div>
        </div>
            <?php
                            ...
                            <table class="table table-hover table-striped table-bordered">
                                <thead>
                                    <tr>
                                        ...
                                        <th class="text-center">Estado Unidades</th>
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <?php
                                            ...
                                            // Condicionales para mostrar el estado con diferentes colores
                                            switch ($estado) {
                                                case 'Resuelto':
                                                    echo '<span class="badge bg-success text-white rounded-pill fw-bold" style="background-color: green;">' . $estado . '</span>';
                                                    break;
                                                case 'En proceso':
                                                case 'pendiente_out':
                                                    // Si el estado es 'pendiente_out', lo mostramos como 'pendiente'
                                                    $displayEstado = ($estado == 'pendiente_out') ? 'Pendiente' : $estado;
                                                    echo '<span class="badge" style="background-color: orange; color: white;" class="rounded-pill fw-bold">' . $displayEstado . '</span>';
                                                    break;
                                                case 'Pendiente':
                                                    echo '<span class="badge bg-danger text-white rounded-pill fw-bold" style="background-color: red;">' . $estado . '</span>';
                                                    break;
                                                default:
                                                    echo '<span class="badge rounded-pill fw-bold">' . $estado . '</span>';
                                                    break;
                                            }
                                            ?>
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-sm-7 animated flip">
                    <h1 class="text-danger">Lo sentimos esta página es solamente para administradores de Tranlisur</h1>
